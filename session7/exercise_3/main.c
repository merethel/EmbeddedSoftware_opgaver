...
#define TASK_MY_TASK_PRIORITY			( tskIDLE_PRIORITY + 2 )
#define	TASK_MY_SECOND_TASK_PRIORITY	( tskIDLE_PRIORITY + 3 )
...
unsigned long long globalInt=0;
unsigned int randomNumber = 0;

// --------------------------------------------------------------------------------------
void taskMyTask(void* pvParameters)
{
	while (globalInt<10000000000) //Heavy calculation!
    {
        globalInt++;
    }
